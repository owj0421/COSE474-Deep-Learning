    ...
    def __init__(self, in_channels, middle_channels, out_channels, downsample=False):
        ...
        if self.downsample:
            self.layer = nn.Sequential(
                ...
                conv1x1(in_channels=in_channels, out_channels=middle_channels,
                        stride=1, padding=0),
                conv3x3(in_channels=middle_channels, out_channels=middle_channels, 
                        stride=2, padding=1),
                conv1x1(in_channels=middle_channels, out_channels=out_channels, 
                        stride=1, padding=0)
